...
export default function AdminSidebar({ isMobile = false, onCloseMobile }) {
  ...
  return (
    <aside className="w-64 h-full bg-slate-950 text-slate-300 border-r border-slate-800 flex flex-col justify-between select-none">
      <div>
        {/* Brand Header */}
        <div className="h-16 flex items-center px-5 border-b border-slate-800/80">
          <Link to="/admin/users" onClick={handleNavClick} className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold text-rose-400 tracking-wider uppercase">Admin Console</span>
            </div>
          </Link>
        </div>

        {/* Admin User Info */}
        <div className="p-3 mx-3 my-3 bg-slate-900 rounded-xl border border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] font-medium text-rose-400">Root Administrator</div>
            </div>
          </div>
        </div>
      ...
      <div className="p-3 border-t border-slate-800/80 space-y-1">
        <Link
          to="/"
          className="flex items-center justify-between px-3 py-2 text-xs text-slate-400 hover:text-slate-200 transition rounded-lg hover:bg-slate-900"
        >
